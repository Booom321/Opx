...
namespace Algorithm {
    ...
    OPX_NODISCARD OPX_CONSTEXPR Bool Equal(LhsIterator lhsFirst, LhsIterator lhsLast,
    ...
    OPX_NODISCARD Bool Equal(LhsIterator lhsFirst, LhsIterator lhsLast, RhsIterator rhsFirst,
                             Predicate pred) {
        for (; lhsFirst != lhsLast; ++lhsFirst, ++rhsFirst) {
